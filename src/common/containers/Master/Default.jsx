        ...
        >
          ...
          <SubMenu title={<span><Icon type="user" />我的</span>}>
            ...
            <MenuItemGroup title="分组2">
              ...
              <Menu.Item key="setting:5">选项5</Menu.Item>
            </MenuItemGroup>
            <MenuItemGroup title="分组3">
              <Menu.Item key="setting:6">选项6</Menu.Item>
              <Menu.Item key="setting:7">选项7</Menu.Item>
              <Menu.Item key="setting:8">选项8</Menu.Item>
            </MenuItemGroup>
          </SubMenu>
          <SubMenu title = {<span><Icon type = 'star-o' />动态</span>}>
            <Menu.Item key="setting:1">你的动态</Menu.Item>
            <Menu.Item key="setting:2">我的动态</Menu.Item>
            </SubMenu>
          <Menu.Item key="app" >
